    ...
    return (
        <div>
            <Head>
                ...
                <meta name="description" content="A space for testing Canada.ca Checkboxes" />
            ...
            <main className={styles.InputsMain}>
                <div className={styles.container}>
                    <section className={styles.InputsSection}>
                        <h1>Checkboxes</h1>
                        <p>Some checkbox styles for proposal. Here we can test the interactive states together. Sometimes it's harder to visualize these things working together in figma.</p>
                    </section>

                    <section className={styles.InputsSection}>
                        <h2>Checkbox button height/width</h2>
                    ...
                    <section className={styles.InputsSection}>
                        ...
                        <fieldset>
                            ...
                            <div class="wrapper">
                                <input id="a11y-issue-1a" name="a11y-issues" type="checkbox" value="no-issues" />
                                <label for="a11y-issue-1a">There are no issues.</label>
                            </div>

                            <div class="wrapper">
                                <input id="a11y-issue-2a" name="a11y-issues" type="checkbox" value="no-focus-styles" />
                                <label for="a11y-issue-2a">Focus styles are not present.</label>
                            </div>

                            <div class="wrapper">
                                <input id="a11y-issue-3a" name="a11y-issues" type="checkbox" value="html-markup" />
                    ...
                    <section className={styles.InputsSection}>
                        ...
                        <fieldset>
                            ...
                            <div class="wrapper">
                                <input id="a11y-issue-1b" name="a11y-issues" type="checkbox" value="no-issues" />
                                <label for="a11y-issue-1b">There are no issues.</label>
                            </div>

                            <div class="wrapper">
                                <input id="a11y-issue-2b" name="a11y-issues" type="checkbox" value="no-focus-styles" />
                                <label for="a11y-issue-2b">Focus styles are not present.</label>
                            </div>

                            <div class="wrapper">
                                <input id="a11y-issue-3b" name="a11y-issues" type="checkbox" value="html-markup" />
                    ...
                    <section className={styles.InputsSection}>
                        ...
                        <fieldset>
                            ...
                            <div class="wrapper">
                                <input className="error" id="a11y-issue-1c" name="a11y-issues" type="checkbox" value="no-issues" />
                                <label className="error" for="a11y-issue-1c">There are no issues.</label>
                            </div>

                            <div class="wrapper">
                                <input className="error" id="a11y-issue-2c" name="a11y-issues" type="checkbox" value="no-focus-styles" />
                                <label className="error" for="a11y-issue-2c">Focus styles are not present.</label>
                            </div>

                            <div class="wrapper">
                                <input className="error" id="a11y-issue-3c" name="a11y-issues" type="checkbox" value="html-markup" />
                    ...
                    <section className={styles.InputsSection}>
                        ...
                        <fieldset>
                            ...
                            <p className="hint">Choose all the options that apply to you from the list below</p>
                            <div class="wrapper">
                                <input id="a11y-issue-1d" name="a11y-issues" type="checkbox" value="no-issues" />
                                <label for="a11y-issue-1d">There are no issues.</label>
                            </div>

                            <div class="wrapper">
                                <input id="a11y-issue-2d" name="a11y-issues" type="checkbox" value="no-focus-styles" />
                                <label for="a11y-issue-2d">Focus styles are not present.</label>
                            </div>

                            <div class="wrapper">
                                <input id="a11y-issue-3d" name="a11y-issues" type="checkbox" value="html-markup" />
                    ...
                    <section className={styles.InputsSection}>
                        ...
                        <fieldset>
                            ...
                            <div class="wrapper">
                                <input disabled id="a11y-issue-1" name="a11y-issues" type="checkbox" value="no-issues" />
