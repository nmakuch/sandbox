        ...
        <div>
            ...
            <main className={styles.InputsMain}>
                <div className={styles.container}>
                    ...
                    <section className={styles.InputsSection}>
                        <h2>Input height</h2>
                        <p>To ensure we have an accessible touch target for our inputs on mobile, we should make sure they are 44px in height at a minimum. The inputs on this page (line height + padding) are 48px in height.</p>
                    </section>
                    ...
                    <section className={styles.InputsSection}>
                        ...
                        <p>
                            ...
                            A general rule for <a href="https://practicaltypography.com/line-length.html">line length</a> states that lines 
